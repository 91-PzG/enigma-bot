...
const config: Config.InitialOptions = {
  ...
  globals: {
    ...
    __hr:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJodW1hblJlc291cmNlcyIsInVzZXJuYW1lIjoiSHVtYW5SZXNvdXJjZXMiLCJyb2xlcyI6WyJtZW1iZXIiLCJociJdLCJpYXQiOjE2MTQyNzE0NDUsImV4cCI6MTYxNDMwNzQ0NX0.IUbayeFgsr2OkHmAHCL3YzDhOwKirX4wt4x8sidf3u8',
    __signIn:
